...
public interface AuctionRepository extends JpaRepository<Auction, Long> {
	...
	@Query("SELECT a FROM Auction a WHERE a.product.id = :productId ORDER BY a.id DESC")
	Optional<Auction> findFirstByProductIdOrderByIdDescForRead(@Param("productId") Long productId);
	...
	List<Auction> findWinner(Long productId, Pageable pageable);
